  ...
  return (
    <div className="p-8">
      <div className="relative text-center mb-16">
        <h1 className="text-7xl md:text-9xl font-extrabold bg-clip-text">
          <span className="text-[#c8aeff] opacity-30">EVERY</span><br/>
          <span className="text-[#9ff3fe] opacity-30">WHERE</span>
        </h1>
